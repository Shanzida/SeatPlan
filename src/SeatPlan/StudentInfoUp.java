 ...
 * @author urmi
 */
public class StudentInfoUp extends javax.swing.JFrame {

    /**
     * Creates new form Entry
     */
    public StudentInfoUp() {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Student Info Delete ");
        getContentPane().add(jLabel10);
        jLabel10.setBounds(140, 30, 400, 51);
        ...
        jButton2.setBounds(430, 220, 90, 30);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Year");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(340, 110, 60, 30);
       ...
       if(Year.equalsIgnoreCase("Select")){
        ...
        try{
          ...
          //  ResultSet rs= stmt.executeQuery(checkSql);
            ...
            String sql = "DELETE from studentinfo where semester='"+semester+"'and Year='"+Year+"'";
    ...
    /* public static void main(String args[]) {
       ...
       /*  //<editor-fold defaultstate="collapsed" desc=" Look and feel setting code (optional) ">
         ...
         */
         /*try {
            ...
            java.util.logging.Logger.getLogger(StudentInfoUp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
      ...
      /* java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentInfoUp().setVisible(true);
            }
        });
    }*/
